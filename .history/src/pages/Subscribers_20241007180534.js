    ...
    <div className="p-8 min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md flex items-center">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold text-gray-800 dark:text-gray-100">{stats.active}</p>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md flex items-center">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold text-gray-800 dark:text-gray-100">{stats.unsubscribed}</p>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md flex items-center">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold text-gray-800 dark:text-gray-100">{stats.newThisWeek}</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-8 flex flex-wrap items-center justify-between">
        <div className="flex items-center w-full md:w-auto mb-4 md:mb-0">
          <div className="relative">
            ...
            <input
              ...
              className="border border-indigo-200 dark:border-indigo-700 bg-white dark:bg-gray-800 rounded-md pl-10 pr-3 py-2 w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:focus:ring-indigo-600 text-gray-800 dark:text-gray-100"
              value={searchTerm}
        ...
        <div className="flex items-center">
          ...
          <select
            className="border border-indigo-200 dark:border-indigo-700 bg-white dark:bg-gray-800 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:focus:ring-indigo-600 text-gray-800 dark:text-gray-100"
            value={statusFilter}
      ...
      <div className="bg-white dark:bg-gray-800 p-6 shadow-lg rounded-xl mb-8">
        <h2 className="text-2xl font-semibold text-indigo-700 dark:text-indigo-400 mb-6">Subscriber List</h2>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-indigo-50 dark:bg-indigo-900">
                ...
                <th className="py-3 px-4 font-semibold text-indigo-600 dark:text-indigo-300">Email</th>
                <th className="py-3 px-4 font-semibold text-indigo-600 dark:text-indigo-300">Subscription Date</th>
            ...
            <tbody>
              {filteredSubscribers.map((subscriber) => (
                ...
                >
                  <td className="py-4 px-4 font-medium text-gray-800 dark:text-gray-200">{subscriber.name}</td>
                  <td className="py-4 px-4 text-gray-600 dark:text-gray-400">{subscriber.email}</td>
                  <td className="py-4 px-4 text-gray-600 dark:text-gray-400">{subscriber.subscriptionDate}</td>
                  <td className="py-4 px-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                      subscriber.status === 'Active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' :
