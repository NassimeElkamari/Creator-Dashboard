...
const initialUsers = [
  ...
  { id: 2, name: 'Ali', email: 'ali@example.com', role: 'user', status: 'inactive', registrationDate: '2024-10-01' },
  { id: 3, name: 'Sarah Johnson', email: 'sarah@example.com', role: 'moderator', status: 'active', registrationDate: '2023-05-15' },
  { id: 4, name: 'Mike Chen', email: 'mike@example.com', role: 'user', status: 'active', registrationDate: '2023-08-22' },
  { id: 5, name: 'Emily Brown', email: 'emily@example.com', role: 'admin', status: 'inactive', registrationDate: '2022-12-10' },
  { id: 6, name: 'Alex Rodriguez', email: 'alex@example.com', role: 'user', status: 'active', registrationDate: '2024-02-28' },
  { id: 7, name: 'Olivia Taylor', email: 'olivia@example.com', role: 'moderator', status: 'active', registrationDate: '2023-11-05' },
  { id: 8, name: 'David Kim', email: 'david@example.com', role: 'user', status: 'inactive', registrationDate: '2023-07-19' },
];
