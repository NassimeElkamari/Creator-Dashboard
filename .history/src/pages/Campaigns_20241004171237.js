...
import { FiEye, FiEdit2, FiTrash2, FiBarChart2 } from 'react-icons/fi';
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white p-6 shadow-lg rounded-xl mb-8">
        <h2 className="text-2xl font-semibold text-gray-700 mb-6">Campaign List</h2>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="py-3 px-4 font-semibold text-gray-600">Open Rate</th>
                <th className="py-3 px-4 font-semibold text-gray-600">Click Rate</th>
