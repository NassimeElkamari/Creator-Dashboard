        ...
        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
          {notifications.map(notification => (
            <tr key={notification.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{notification.title}</td>
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 max-w-xs truncate">{notification.message}</td>
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{notification.recipient}</td>
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{notification.status}</td>
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{notification.type}</td>
              <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{notification.sentDateTime}</td>
