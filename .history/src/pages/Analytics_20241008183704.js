...
const Analytics = () => {
  ...
  const chartOptions = {
    ...
    plugins: {
      legend: {
        labels: {
          color: 'currentColor', // This will use the current text color
        },
      },
    },
    scales: {
      x: {
        ticks: { color: 'currentColor' }, // Use current text color
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200">
              ...
              {geographicData.map(({ country, coordinates, subscribers }) => (
                <Marker key={country} coordinates={coordinates}>
                  ...
                  <text
                    ...
                    style={{ fontSize: '8px', fill: 'currentColor' }} // Use current text color
                  >
                    {subscribers}
                  </text>
                </Marker>
