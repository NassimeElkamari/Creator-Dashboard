    ...
    <div className="w-64 h-screen bg-gray-800 text-white">
      ...
      <nav className="mt-10">
        <ul className="space-y-4">
          <li>
            <Link to="/dashboard/overview" className=" p-4 hover:bg-gray-700 flex items-center">
              <FaHome className="mr-2" /> Dashboard
            </Link>
          </li>
          <li>
            <Link to="/dashboard/campaigns" className=" p-4 hover:bg-gray-700 flex items-center">
              <FaBullhorn className="mr-2" /> Campaigns
            </Link>
          </li>
          <li>
            <Link to="/dashboard/subscribers" className=" p-4 hover:bg-gray-700 flex items-center">
          ...
          <li>
            <Link to="/dashboard/notifications" className=" p-4 hover:bg-gray-700 flex items-center">
              <FaBell className="mr-2" /> Notifications
            </Link>
          </li>
          <li>
            <Link to="/dashboard/settings" className=" p-4 hover:bg-gray-700 flex items-center justify-center">
