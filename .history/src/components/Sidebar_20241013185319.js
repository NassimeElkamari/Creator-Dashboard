          ...
          <li className="relative">
            <div className="p-4 ml-4">
              <button 
                ...
                className="flex items-center bg-[#dfdaf8] border border-purple-600 text-purple-900 pr-4 rounded-lg w-full"
              >
                <div className="pl-4 flex items-center flex-grow hover:bg-purple-300 pr-2 py-2 border-r border-purple-600 transition-all duration-500">
                  <FaPenToSquare className="mr-2 text-purple-900" /> Start writing
                </div>
              ...
              {openSections.writing && (
                <ul className="absolute top-full left-0 w-full mt-2 space-y-2 bg-white bg-opacity-150 dark:bg-purple-900 dark:bg-opacity-30 rounded-lg p-2 z-10">
                  <li>
                    <Link to="/dashboard/newCampaign" className="block px-4 py-2 text-black text hover:bg-gray-200 rounded">
                      Upload Video
                    </Link>
                  </li>
                  <li>
