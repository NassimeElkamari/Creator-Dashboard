          ...
          <li className={`${isCollapsed ? 'flex justify-center' : ''}`}>
            <div className={`${isCollapsed ? 'w-10' : 'w-full '}`}>
              <button 
                ...
                className={`flex items-center bg-[#dfdaf8] py-2 mt-3 border border-purple-600 text-purple-900 rounded-lg ${isCollapsed ? 'w-10 h-10 justify-center' : 'w-full pl-2'}`}
              >
                <div className="flex items-center hover:bg-purple-600">
