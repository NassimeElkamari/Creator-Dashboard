...
const StatCard = ({ title, value, subtitle, percentage, icon, style }) => (
  <div className={`bg-white shadow-md p-3 flex items-center ${style}`}>
    ...
    <div className="py-3">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 rounded-xl">
        <StatCard
          ...
          style="rounded-l-xl border-r-gray-300"
          percentage="5.3"
        ...
        <StatCard
          title="Click Rate"
          value="42.3%"
          style="rounded-r-xl border border-l-gray-300"
          subtitle="from 0 (last 4 weeks)"
          percentage="1.8"
