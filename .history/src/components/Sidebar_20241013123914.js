          ...
          <li>
            <div className="p-4 ml-4">
              <button 
                ...
                className="flex items-center bg-purple-500 text-white px-4 py-2 rounded-lg w-full"
              >
                <FaPen className="mr-2" /> Start writing
                {openSections.writing ? <IoIosArrowUp className="ml-auto" /> : <IoIosArrowDown className="ml-auto" />}
              </button>
              {openSections.writing && (
                <ul className="mt-2 space-y-2 bg-purple-100 dark:bg-purple-900 rounded-lg p-2">
                  <li>
                    <Link to="/dashboard/upload-video" className="block px-4 py-2 text-purple-700 dark:text-purple-300 hover:bg-purple-200 dark:hover:bg-purple-800 rounded">
                      Upload Video
                    </Link>
                  </li>
                  <li>
