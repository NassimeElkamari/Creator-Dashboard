          ...
          <li>
            <div className={`${isCollapsed ? 'mx-auto w-10' : 'ml-4'}`}>
              <button 
                ...
                className={`flex items-center bg-[#dfdaf8] border border-purple-600 text-purple-900 rounded-lg ${isCollapsed ? 'w-10 h-10 justify-center opacity-50 cursor-not-allowed' : 'w-full'}`}
