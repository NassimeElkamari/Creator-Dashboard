          ...
          <li className={`${isCollapsed ? 'flex justify-center' : ''}`}>
            <div className={`${isCollapsed ? 'w-10' : 'w-full '}`}>
              <button 
                ...
                className={`flex items-center bg-[#dfdaf8]  mt-3 border border-purple-600 text-purple-900 rounded-lg ${isCollapsed ? 'w-10 h-10 justify-center' : 'w-full rounded-xl'}`}
              >
                <div className="flex items-center hover:bg-purple-600 py-2 pl-2">
