          ...
          <li>
            <div className="p-4 ml-4">
              <button 
                ...
                className="flex items-center bg-[#dfdaf8] border border-purple-600 text-purple-700 px-4  rounded-lg w-full"
              >
                <div className="flex items-center flex-grow pr-2 py-2 border-r border-purple-600">
                  <FaPen className="mr-2" /> Start writing
                </div>
                {openSections.writing ? <IoIosArrowUp className="ml-3" /> : <IoIosArrowDown className="ml-3" />}
              </button>
