    ...
    <div className="w-64 h-screen bg-gray-800 text-white">
      ...
      <nav className="mt-10">
        <ul className="space-y-4">
          <li>
            <Link to="/dashboard/overview" className="ml-4 gap p-4 hover:bg-gray-700 flex items-center">
          ...
          <li>
            <Link to="/dashboard/settings" className=" p-4 hover:bg-gray-700 flex items-center ">
