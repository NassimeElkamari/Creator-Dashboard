...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-900 pr-12 text-gray-600 dark:text-gray-300 h-screen flex flex-col transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
      {/* Branding */}
