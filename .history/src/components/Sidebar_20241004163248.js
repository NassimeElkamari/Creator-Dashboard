...
const Sidebar = () => {
  ...
  const getLinkClasses = (path) => {
    return location.pathname === path
      ? 'ml-4 gap-2 p-4 text-lg bg-blue-500 text-white flex items-center' // Active link style
      : 'ml-4 gap-2 p-4 text-lg hover:bg-gray-700 flex items-center'; // Default link style
  };
