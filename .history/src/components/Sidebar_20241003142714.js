    ...
    <div className="w-64 h-screen bg-gray-800 text-white">
      ...
      <nav className="mt-10">
        <ul className="space-y-4">
          ...
          <li>
            <Link to="/dashboard/emailPerformance" className="block p-4 hover:bg-gray-700 flex items-center">
              <FaEnvelope className="mr-2" /> Email Performance
            </Link>
          </li>
          <li>
            <Link to="/dashboard/contentModeration" className="block p-4 hover:bg-gray-700 flex items-center">
              <FaUsers className="mr-2" /> Content Moderation
            </Link>
          </li>
          <li>
            <Link to="/dashboard/analytics" className="block p-4 hover:bg-gray-700 flex items-center">
              <FaChartBar className="mr-2" /> Analytics
            </Link>
          </li>
          <li>
            <Link to="/dashboard/userManagement" className="block p-4 hover:bg-gray-700 flex items-center">
