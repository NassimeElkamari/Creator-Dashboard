          ...
          <li>
            <div className="p-4 ml-4">
              <button 
                ...
                className="flex items-center bg-[#dfdaf8] border border-purple-600 text-black px-4 py-2 rounded-lg w-full"
              >
                <div className="flex items-center flex-grow pr-2 border-r border-purple-600">
